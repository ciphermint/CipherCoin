Contributing to CipherCoin Core
============================

The CipherCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CipherCoin Core project, and is not to be
confused with overall CipherCoin Network Protocol consensus changes.

Whether a pull request is merged into CipherCoin Core rests with the project merge
...
Patches that change CipherCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CipherCoin consensus, it must have been
...
The project leader is the release manager for each CipherCoin Core release.
