...
In order to support loading of multiple wallets in ciphercoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ciphercoin.cpp.
...
Changes to ciphercoin.cpp
----------------------
ciphercoin.cpp is the entry point into ciphercoin-qt, and as such, will require some minor modifications to provide hooks for
