...
This mechanism has been integrated into Bitcore-Node-CipherCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CipherCoin-Project/insight-api-ciphercoin#web-socket-api](https://github.com/CipherCoin-Project/insight-api-ciphercoin#web-socket-api) 
* API: [https://github.com/CipherCoin-Project/insight-api-ciphercoin#swifttx-transactions](https://github.com/CipherCoin-Project/insight-api-ciphercoin#swifttx-transactions) 
...
By default, the CipherCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CipherCoin Core daemon:
