...
#   c) node1 mines 32 blocks, so now node 0 has 60001ciph, node 1 has 4250ciph, node2 has none.
#   d) node0 sends 601 ciph to node2, in two transactions (301 ciph, then 300 ciph).
