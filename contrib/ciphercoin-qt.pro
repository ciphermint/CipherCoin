...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/ciphercoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ciphercoin-cli.cpp \
           src/ciphercoin-tx.cpp \
           src/ciphercoin.cpp \
           src/db.cpp \
           ...
           src/qt/ciphercoin.cpp \
           src/qt/ciphercoinstrings.cpp \
...
RESOURCES += src/qt/ciphercoin.qrc src/qt/ciphercoin_locale.qrc

TRANSLATIONS += src/qt/locale/ciphercoin_bg.ts \
                src/qt/locale/ciphercoin_de.ts \
                src/qt/locale/ciphercoin_en.ts \
                src/qt/locale/ciphercoin_es.ts \
                src/qt/locale/ciphercoin_fi.ts \
                src/qt/locale/ciphercoin_fr.ts \
                src/qt/locale/ciphercoin_it.ts \
                src/qt/locale/ciphercoin_ja.ts \
                src/qt/locale/ciphercoin_pl.ts \
                src/qt/locale/ciphercoin_pt.ts \
                src/qt/locale/ciphercoin_ru.ts \
                src/qt/locale/ciphercoin_sk.ts \
                src/qt/locale/ciphercoin_sv.ts \
                src/qt/locale/ciphercoin_vi.ts \
                src/qt/locale/ciphercoin_zh_CN.ts \
                src/qt/locale/ciphercoin_zh_TW.ts
