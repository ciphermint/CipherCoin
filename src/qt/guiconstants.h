...
/* CipherCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CipherCoin"
#define QAPP_ORG_DOMAIN "ciphercoin.org"
#define QAPP_APP_NAME_DEFAULT "CipherCoin-Qt"
#define QAPP_APP_NAME_TESTNET "CipherCoin-Qt-testnet"
