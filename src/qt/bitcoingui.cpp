                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CipherCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CipherCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ciphercoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCIPH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CipherCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CipherCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CipherCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CipherCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CipherCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a CipherCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CipherCoin Core help message to get a list with possible CipherCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CipherCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CipherCoin network", "", count));
}
...
{
    QString strTitle = tr("CipherCoin Core"); // default title
