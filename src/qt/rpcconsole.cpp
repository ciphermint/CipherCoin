                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCIPHPathCustom = GetArg("-zciphbackuppath", "");
    ...
    if(!strzCIPHPathCustom.empty()) {
        ui->wallet_customzciphbackuppath->setText(QString::fromStdString(strzCIPHPathCustom));
        ui->wallet_customzciphbackuppath_label->setVisible(true);
        ui->wallet_customzciphbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCIPHPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the CipherCoin RPC console.") + "<br>" +
