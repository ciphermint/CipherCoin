...
/** Utility functions used by the CipherCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CipherCoin addresses in monospace font
...
// Parse "ciphercoin:" URI into recipient object, return true on successful parsing
