...
/**
 * CipherCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzciphseed(const UniValue& params, bool fHelp);
extern UniValue getzciphseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzciph(const UniValue& params, bool fHelp);
extern UniValue dzciphstate(const UniValue& params, bool fHelp);
