...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CipherCoin Core ciphercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ciphercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ciphercoin transaction") + "\n" +
                               "  ciphercoin-tx [options] -create [commands]   " + _("Create hex-encoded ciphercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ciphercoin transaction
