/* src/config/ciphercoin-config.h.  Generated from ciphercoin-config.h.in by configure.  */
/* src/config/ciphercoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CIPH_CONFIG_H

#define CIPH_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.ciphercoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CipherCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CipherCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ciphercoin"
