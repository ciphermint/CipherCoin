...
#ifndef CipherCoin_STAKEINPUT_H
#define CipherCoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZCIPH() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zCIPHStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zciph, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZCIPH() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZCIPH() override { return false; }
};


#endif //CipherCoin_STAKEINPUT_H
