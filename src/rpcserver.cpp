...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CipherCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "CipherCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CipherCoin features */
        {"ciphercoin", "masternode", &masternode, true, true, false},
        {"ciphercoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ciphercoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ciphercoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ciphercoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ciphercoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ciphercoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ciphercoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ciphercoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ciphercoin", "startmasternode", &startmasternode, true, true, false},
        {"ciphercoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ciphercoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ciphercoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ciphercoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ciphercoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ciphercoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ciphercoin", "mnbudget", &mnbudget, true, true, false},
        {"ciphercoin", "preparebudget", &preparebudget, true, true, false},
        {"ciphercoin", "submitbudget", &submitbudget, true, true, false},
        {"ciphercoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ciphercoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ciphercoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ciphercoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ciphercoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ciphercoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ciphercoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ciphercoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ciphercoin", "mnsync", &mnsync, true, true, false},
        {"ciphercoin", "spork", &spork, true, true, false},
        {"ciphercoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzciphseed", &getzciphseed, false, false, true},
        {"zerocoin", "setzciphseed", &setzciphseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzciph", &searchdzciph, false, false, true},
        {"zerocoin", "dzciphstate", &dzciphstate, false, false, true}
...
{
    return "> ciphercoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6281/\n";
}
